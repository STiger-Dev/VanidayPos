...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"fugit","ip_address":"iste","latitude":"quaerat","longitude":"beatae"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"vero","latitude":"non","longitude":"et"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=consequuntur&follow_up_type=facere&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"ea","schedule_type":"nobis","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=ut&biz_name=et&mobile_num=10&contact_id=soluta&order_by=minus&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"esse","mobile_name":"omnis","call_type":"call","start_time":"voluptatum","end_time":"vel","duration":"placeat"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":510077.5801195999956689774990081787109375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":59404797.600000001490116119384765625,"total_card_slips":12,"total_cheques":13,"closing_note":"incidunt","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 510077.5801195999956689774990081787109375,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 59404797.600000001490116119384765625,
    "total_card_slips": 12,
    "total_cheques": 13,
    "closing_note": "incidunt",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=culpa&name=rerum&biz_name=consequatur&mobile_num=20&contact_id=suscipit&order_by=qui&direction=eaque&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"tenetur","prefix":"adipisci","first_name":"ab","middle_name":"vero","last_name":"quaerat","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"aut","address_line_2":"quia","city":"cumque","state":"non","country":"temporibus","zip_code":"mollitia","customer_group_id":"autem","contact_id":"quis","dob":"2000-06-13","custom_field1":"reiciendis","custom_field2":"asperiores","custom_field3":"qui","custom_field4":"praesentium","email":"nihil","shipping_address":"voluptatem","position":"ut","opening_balance":0,"source_id":14,"life_stage_id":2,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "tenetur",
    "prefix": "adipisci",
    "first_name": "ab",
    "middle_name": "vero",
    "last_name": "quaerat",
    ...
    "contact_id": "quis",
    "dob": "2000-06-13",
    "custom_field1": "reiciendis",
    "custom_field2": "asperiores",
    "custom_field3": "qui",
    "custom_field4": "praesentium",
    "email": "nihil",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"et","prefix":"incidunt","first_name":"tenetur","middle_name":"veritatis","last_name":"eligendi","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"sed","address_line_2":"quo","city":"quos","state":"ut","country":"in","zip_code":"et","customer_group_id":"velit","contact_id":"laborum","dob":"2000-06-13","custom_field1":"aspernatur","custom_field2":"voluptas","custom_field3":"a","custom_field4":"iure","email":"consequatur","shipping_address":"ut","position":"laboriosam","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":9,"life_stage_id":18,"assigned_to":[]}'
...
let body = {
    ...
    "country": "in",
    "zip_code": "et",
    "customer_group_id": "velit",
    "contact_id": "laborum",
    "dob": "2000-06-13",
    "custom_field1": "aspernatur",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":7,"card_number":"quasi","card_holder_name":"inventore","card_transaction_number":"aut","card_type":"sint","card_month":"non","card_year":"vero","card_security":"et","transaction_no_1":"nesciunt","transaction_no_2":"cum","transaction_no_3":"officiis","cheque_number":"id","bank_account_number":"ad","note":"quaerat"}'
...
let body = {
    ...
    "account_id": 7,
    "card_number": "quasi",
    "card_holder_name": "inventore",
    "card_transaction_number": "aut",
    "card_type": "sint",
    "card_month": "non",
    "card_year": "vero",
    "card_security": "et",
    "transaction_no_1": "nesciunt",
    "transaction_no_2": "cum",
    "transaction_no_3": "officiis",
    "cheque_number": "id",
    "bank_account_number": "ad",
    "note": "quaerat"
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=accusantium&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":879941,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":17,"contact_id":20,"expense_category_id":8,"expense_sub_category_id":2,"additional_notes":"totam","is_refund":0,"is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"et","recur_repetitions":16,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":16,"card_number":"incidunt","card_holder_name":"velit","card_transaction_number":"optio","card_type":"eum","card_month":"cum","card_year":"nobis","card_security":"est","transaction_no_1":"inventore","transaction_no_2":"aut","transaction_no_3":"aperiam","note":"ea","cheque_number":"ipsa"}]}'
    ...
    "payment": [
        {
            ...
            "method": "cash",
            "account_id": 16,
            "card_number": "incidunt",
            "card_holder_name": "velit",
            "card_transaction_number": "optio",
            "card_type": "eum",
            "card_month": "cum",
            "card_year": "nobis",
            "card_security": "est",
            "transaction_no_1": "inventore",
            "transaction_no_2": "aut",
            "transaction_no_3": "aperiam",
            "note": "ea",
            "cheque_number": "ipsa"
        }
    ]
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":2.45999999999999996447286321199499070644378662109375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":9,"contact_id":10,"expense_category_id":4,"expense_sub_category_id":10,"additional_notes":"repellat","is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"facere","recur_repetitions":4,"payment":[]}'
...
let body = {
    "final_total": 2.45999999999999996447286321199499070644378662109375,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 15,
    "expense_for": 9,
    "contact_id": 10,
    ...
    "additional_notes": "repellat",
    "is_recurring": 0,
    "recur_interval": 13,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "facere",
    "recur_repetitions": 4,
    "payment": []
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=iure&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=laboriosam&assigned_to=quaerat&status=rem&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":16,"visit_to":"distinctio","visit_address":"eos","assigned_to":3,"visit_on":"2021-12-28 17:23:00","visit_for":"maxime"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"esse","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"laboriosam","photo":"aut"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "esse",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=voluptatem&order_direction=dolorem&brand_id=quos&category_id=ipsam&sub_category_id=aliquam&location_id=1&selling_price_group=culpa&send_lot_detail=qui&name=libero&sku=consequuntur&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "voluptatem",
    "order_direction": "dolorem",
    "brand_id": "quos",
    "category_id": "ipsam",
    "sub_category_id": "aliquam",
    "location_id": "1",
    "selling_price_group": "culpa",
    "send_lot_detail": "qui",
    "name": "libero",
    "sku": "consequuntur",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=officiis&send_lot_detail=architecto" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "selling_price_group": "officiis",
    "send_lot_detail": "architecto",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=voluptate&location_id=1&brand_id=dignissimos&category_id=ipsam&sub_category_id=pariatur&not_for_selling=nihil&name=amet&sku=eveniet&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "category_id": "ipsam",
    "sub_category_id": "pariatur",
    "not_for_selling": "nihil",
    "name": "amet",
    "sku": "eveniet",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=doloremque&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=et&service_staff_id=et&shipping_status=ordered&source=ducimus&only_subscriptions=est&send_purchase_details=minus&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "source": "ducimus",
    "only_subscriptions": "est",
    "send_purchase_details": "minus",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":9,"transaction_date":"2020-07-22 15:48:29","invoice_no":"fuga","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":2,"discount_amount":10,"discount_type":"fixed","sale_note":"enim","staff_note":"vel","commission_agent":12,"shipping_details":"Express Delivery","shipping_address":"et","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":7,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":19,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"cumque","recur_repetitions":5,"rp_redeemed":18,"rp_redeemed_amount":13.5,"types_of_service_id":15,"service_custom_field_1":"adipisci","service_custom_field_2":"nesciunt","service_custom_field_3":"et","service_custom_field_4":"rerum","service_custom_field_5":"ducimus","service_custom_field_6":"ut","round_off_amount":0.6373379999999999601101308144279755651950836181640625,"table_id":1,"service_staff_id":13,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"provident"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":7,"card_number":"praesentium","card_holder_name":"adipisci","card_transaction_number":"qui","card_type":"esse","card_month":"assumenda","card_year":"vel","card_security":"earum","transaction_no_1":"rerum","transaction_no_2":"facilis","transaction_no_3":"quia","bank_account_number":"quis","note":"et","cheque_number":"quaerat"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "cumque",
            "recur_repetitions": 5,
            "rp_redeemed": 18,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 15,
            "service_custom_field_1": "adipisci",
            "service_custom_field_2": "nesciunt",
            "service_custom_field_3": "et",
            "service_custom_field_4": "rerum",
            "service_custom_field_5": "ducimus",
            "service_custom_field_6": "ut",
            "round_off_amount": 0.6373379999999999601101308144279755651950836181640625,
            "table_id": 1,
            "service_staff_id": 13,
            "change_return": 0,
            "products": [
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=eaque" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":10,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":10,"discount_amount":10,"discount_type":"fixed","sale_note":"et","source":"et","staff_note":"similique","is_suspend":false,"commission_agent":4,"shipping_details":"Express Delivery","shipping_address":"molestiae","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":14,"pay_term_type":"months","is_recurring":0,"recur_interval":16,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"quia","recur_repetitions":3,"rp_redeemed":16,"rp_redeemed_amount":13.5,"types_of_service_id":5,"service_custom_field_1":"atque","service_custom_field_2":"eius","service_custom_field_3":"odio","service_custom_field_4":"voluptatem","service_custom_field_5":"et","service_custom_field_6":"corrupti","round_off_amount":45.594034381000000166750396601855754852294921875,"table_id":20,"service_staff_id":1,"change_return":0,"change_return_id":10,"products":[{"sell_line_id":20,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":17,"discount_amount":0,"discount_type":"percentage","sub_unit_id":2,"note":"beatae"}],"payments":[{"payment_id":6,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":9,"card_number":"tenetur","card_holder_name":"soluta","card_transaction_number":"fugit","card_type":"possimus","card_month":"quasi","card_year":"explicabo","card_security":"non","transaction_no_1":"nulla","transaction_no_2":"eius","transaction_no_3":"dolorem","note":"ut","cheque_number":"culpa","bank_account_number":"inventore"}]}'
...
let body = {
    ...
    "sale_note": "et",
    "source": "et",
    "staff_note": "similique",
    "is_suspend": false,
    "commission_agent": 4,
    "shipping_details": "Express Delivery",
    "shipping_address": "molestiae",
    "shipping_status": "ordered",
    "delivered_to": "Mr Robin",
    "shipping_charges": 10,
    "packing_charge": 10,
    ...
    "service_custom_field_1": "atque",
    "service_custom_field_2": "eius",
    "service_custom_field_3": "odio",
    "service_custom_field_4": "voluptatem",
    "service_custom_field_5": "et",
    "service_custom_field_6": "corrupti",
    "round_off_amount": 45.594034381000000166750396601855754852294921875,
    "table_id": 20,
    "service_staff_id": 1,
    "change_return": 0,
    "change_return_id": 10,
    ...
    "payments": [
        {
            ...
            "account_id": 9,
            "card_number": "tenetur",
            "card_holder_name": "soluta",
            "card_transaction_number": "fugit",
            "card_type": "possimus",
            "card_month": "quasi",
            "card_year": "explicabo",
            "card_security": "non",
            "transaction_no_1": "nulla",
            "transaction_no_2": "eius",
            "transaction_no_3": "dolorem",
            "note": "ut",
            "cheque_number": "culpa",
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/eos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":13,"transaction_date":"2020-5-7 15:20:22","invoice_no":"iusto","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":4,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":19,"shipping_status":"ordered","delivered_to":"sunt"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=voluptate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"praesentium","first_name":"incidunt","last_name":"assumenda","email":"facere","is_active":"rerum","user_type":"minima","crm_contact_id":4,"allow_login":true,"username":"commodi","password":"dolores","role":1,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"rerum","max_sales_discount_percent":"natus","selected_contacts":true,"selected_contact_ids":[],"dob":"consequatur","gender":"autem","marital_status":"ea","blood_group":"enim","contact_number":"est","alt_number":"ducimus","family_number":"mollitia","fb_link":"doloremque","twitter_link":"dolorem","social_media_1":"eligendi","social_media_2":"rerum","custom_field_1":"laudantium","custom_field_2":"nulla","custom_field_3":"autem","custom_field_4":"nostrum","guardian_name":"accusamus","id_proof_name":"sed","id_proof_number":"aut","permanent_address":"est","current_address":"quis","bank_details":[{"account_holder_name":"dolorem","account_number":"voluptates","bank_name":"culpa","bank_code":"earum","branch":"rerum","tax_payer_id":"harum"}]}'
...
let body = {
    ...
    "cmmsn_percent": "rerum",
    "max_sales_discount_percent": "natus",
    ...
    "contact_number": "est",
    "alt_number": "ducimus",
    "family_number": "mollitia",
    "fb_link": "doloremque",
    "twitter_link": "dolorem",
    "social_media_1": "eligendi",
    "social_media_2": "rerum",
    "custom_field_1": "laudantium",
    "custom_field_2": "nulla",
    "custom_field_3": "autem",
    "custom_field_4": "nostrum",
    "guardian_name": "accusamus",
    "id_proof_name": "sed",
    "id_proof_number": "aut",
    "permanent_address": "est",
    "current_address": "quis",
    "bank_details": [
        {
            "account_holder_name": "dolorem",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=magnam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"aut","new_password":"porro"}'
