                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success == 1) {
                            ...
                            showSellsDetail(result.transaction_id);
                            toastr.success(result.msg);
...
function showSellsDetail(id) { 
    let url = $('#sells_detail_url').val();
    let booking_url = $('#booking_url').val();
    ...
    $.ajax({
        ...
        success: function(result) {
            console.log(result);
            $('#modal_invoice').html(result);
            $('#modal_invoice').modal('show');
            $('#modal_invoice .modal-footer').append(
                $('<a>Booking Appointment</a>').attr({class: "btn bg-yellow", href: booking_url})
            );
        },
    });
}